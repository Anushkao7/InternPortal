...
<body>
  <header>
    ...
    <nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color">
      <a class="navbar-brand" href="index.php">Internship Portal</a>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <?php 
              if(!isset($_SESSION['email'])){
                ...
                <li class='nav-item'><a href='employer/myaccount.php' class='nav-link' style='border-radius: 10em;'>Faculty</a></li>
                ";
              }
              else{
